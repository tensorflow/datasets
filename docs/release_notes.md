...
*   Add e-SNLI dataset from the paper
    [e-SNLI](https://papers.nips.cc/paper/8163-e-snli-natural-language-inference-with-natural-language-explanations.pdf).
...
*   Add DIV2K dataset from the paper
    [DIV2K](https://www.vision.ee.ethz.ch/~timofter/publications/Agustsson-CVPRW-2017.pdf)
