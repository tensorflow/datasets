...
Name  | Type | Shape
:---- | :--- | :----
attributes|{'Brown_Hair': tf.bool, 'Wearing_Necklace': tf.bool, 'Wearing_Earrings': tf.bool, 'Black_Hair': tf.bool, 'Gray_Hair': tf.bool, 'Bangs': tf.bool, 'Double_Chin': tf.bool, 'Narrow_Eyes': tf.bool, 'Wavy_Hair': tf.bool, 'Heavy_Makeup': tf.bool, 'Big_Lips': tf.bool, 'Big_Nose': tf.bool, 'Sideburns': tf.bool, 'Blond_Hair': tf.bool, 'No_Beard': tf.bool, 'Receding_Hairline': tf.bool, 'High_Cheekbones': tf.bool, 'Arched_Eyebrows': tf.bool, 'Bald': tf.bool, 'Rosy_Cheeks': tf.bool, 'Male': tf.bool, 'Bushy_Eyebrows': tf.bool, 'Oval_Face': tf.bool, 'Pointy_Nose': tf.bool, 'Smiling': tf.bool, 'Chubby': tf.bool, 'Straight_Hair': tf.bool, 'Eyeglasses': tf.bool, 'Pale_Skin': tf.bool, 'Wearing_Necktie': tf.bool, 'Wearing_Hat': tf.bool, 'Mustache': tf.bool, 'Attractive': tf.bool, '5_o_Clock_Shadow': tf.bool, 'Wearing_Lipstick': tf.bool, 'Mouth_Slightly_Open': tf.bool, 'Blurry': tf.bool, 'Bags_Under_Eyes': tf.bool, 'Goatee': tf.bool, 'Young': tf.bool}|{'Brown_Hair': (), 'Wearing_Necklace': (), 'Wearing_Earrings': (), 'Black_Hair': (), 'Gray_Hair': (), 'Bangs': (), 'Double_Chin': (), 'Narrow_Eyes': (), 'Wavy_Hair': (), 'Heavy_Makeup': (), 'Big_Lips': (), 'Big_Nose': (), 'Sideburns': (), 'Blond_Hair': (), 'No_Beard': (), 'Receding_Hairline': (), 'High_Cheekbones': (), 'Arched_Eyebrows': (), 'Bald': (), 'Rosy_Cheeks': (), 'Male': (), 'Bushy_Eyebrows': (), 'Oval_Face': (), 'Pointy_Nose': (), 'Smiling': (), 'Chubby': (), 'Straight_Hair': (), 'Eyeglasses': (), 'Pale_Skin': (), 'Wearing_Necktie': (), 'Wearing_Hat': (), 'Mustache': (), 'Attractive': (), '5_o_Clock_Shadow': (), 'Wearing_Lipstick': (), 'Mouth_Slightly_Open': (), 'Blurry': (), 'Bags_Under_Eyes': (), 'Goatee': (), 'Young': ()}
image|tf.uint8|(218, 178, 3)
landmarks|{'lefteye_y': tf.int64, 'lefteye_x': tf.int64, 'righteye_y': tf.int64, 'righteye_x': tf.int64, 'leftmouth_y': tf.int64, 'leftmouth_x': tf.int64, 'nose_y': tf.int64, 'nose_x': tf.int64, 'rightmouth_y': tf.int64, 'rightmouth_x': tf.int64}|{'lefteye_y': (), 'lefteye_x': (), 'righteye_y': (), 'righteye_x': (), 'leftmouth_y': (), 'leftmouth_x': (), 'nose_y': (), 'nose_x': (), 'rightmouth_y': (), 'rightmouth_x': ()}
