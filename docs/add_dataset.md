...
[`tfds.core.DatasetBuilder`](https://www.tensorflow.org/datasets/api_docs/python/tfds/core/DatasetBuilder)
implementing the following methods:

* `_info`: builds the
  [`DatasetInfo`](https://www.tensorflow.org/datasets/api_docs/python/tfds/core/DatasetInfo) object
...
[`DatasetInfo`](https://www.tensorflow.org/datasets/api_docs/python/tfds/core/DatasetInfo) describes the
dataset.
...
[`tfds.features.FeatureConnector`](https://www.tensorflow.org/datasets/api_docs/python/tfds/features/FeatureConnector).
...
[`tfds.download.DownloadManager`](https://www.tensorflow.org/datasets/api_docs/python/tfds/download/DownloadManager).
...
`tfds.features.FeatureConnector`s](https://www.tensorflow.org/datasets/api_docs/python/tfds/features/FeatureConnector)
...
[features package](https://www.tensorflow.org/datasets/api_docs/python/tfds/features)
for more examples.
