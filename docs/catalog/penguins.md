...
*   **Supervised keys** (See
    [`as_supervised` doc](https://www.tensorflow.org/datasets/api_docs/python/tfds/load#args)):
    `({'flipper_length_mm': 'flipper_length_mm', 'sex': 'sex',
    'culmen_length_mm': 'culmen_length_mm', 'culmen_depth_mm':
    'culmen_depth_mm', 'species': 'species', 'body_mass_g': 'body_mass_g',
    'island': 'island'}, 'species')`
