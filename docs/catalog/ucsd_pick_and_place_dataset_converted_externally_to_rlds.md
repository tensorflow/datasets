...
| episode_metadata/success            | Scalar       |         | bool    | True if the last state of an episode is a success state,     |
:                                     :              :         :         : False otherwise.                                             :
| episode_metadata/success_labeled_by | Text         |         | string  | Who labeled success (and thereby reward) of the episode. Can |
:                                     :              :         :         : be one of\: [human, classifier].                             :
| steps                               | Dataset      |         |         |                                                              |
| steps/action                        | Tensor       | (4,)    | float32 | Robot action, consists of [3x gripper velocities,1x gripper  |
:                                     :              :         :         : open/close torque].                                          :
...
| steps/observation/image             | Image        | (224,   | uint8   | Camera RGB observation.                                      |
:                                     :              : 224, 3) :         :                                                              :
| steps/observation/state             | Tensor       | (7,)    | float32 | Robot state, consists of [3x gripper position,3x gripper     |
:                                     :              :         :         : orientation, 1x finger distance].                            :
