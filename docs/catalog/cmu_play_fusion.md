...
| steps                      | Dataset      |         |         |                                                              |
| steps/action               | Tensor       | (9,)    | float32 | Robot action, consists of [7x delta eef (pos + quat), 1x     |
:                            :              :         :         : gripper open/close (binary), 1x terminate episode].          :
...
:                            :              : 128, 3) :         :                                                              :
| steps/observation/state    | Tensor       | (8,)    | float32 | Robot state, consists of [7x robot joint angles, 1x gripper  |
:                            :              :         :         : position.                                                    :
...
<script>
const url = "https://storage.googleapis.com/tfds-data/visualization/dataframe/cmu_play_fusion-0.1.0.html";
