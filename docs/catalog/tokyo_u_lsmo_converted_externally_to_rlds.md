...
| steps                      | Dataset      |         |         |                                                              |
| steps/action               | Tensor       | (7,)    | float32 | Robot action, consists of [3x endeffector position, 3x euler |
:                            :              :         :         : angles,1x gripper action].                                   :
...
| steps/observation/image    | Image        | (120,   | uint8   | Main camera RGB observation.                                 |
:                            :              : 120, 3) :         :                                                              :
| steps/observation/state    | Tensor       | (13,)   | float32 | Robot state, consists of [3x endeffector position, 3x euler  |
:                            :              :         :         : angles,6x robot joint angles, 1x gripper position].          :
