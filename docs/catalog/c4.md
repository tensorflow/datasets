...
*   `en` (`v2.2.0`) (`Size: 6.96 TiB`): English C4 dataset.

*   `en.noclean` (`v2.2.0`) (`Size: 6.96 TiB`): Disables all cleaning
    (deduplication, removal based on bad words, etc.)

*   `en.realnewslike` (`v2.2.0`) (`Size: 6.96 TiB`): Filters from the default
    config to only include content from the domains used in the 'RealNews'
    dataset (Zellers et al., 2019).

*   `en.webtextlike` (`v2.2.0`) (`Size: 6.96 TiB`): Filters from the default
