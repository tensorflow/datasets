...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'fare': 'fare', 'embarked': 'embarked', 'name': 'name',
    'age': 'age', 'pclass': 'pclass', 'sibsp': 'sibsp', 'home.dest':
    'home.dest', 'parch': 'parch', 'cabin': 'cabin', 'ticket': 'ticket', 'sex':
    'sex', 'body': 'body'}, 'survived')`
