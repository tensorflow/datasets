...
*   **Supervised keys** (See
    ...
    `({'name': 'name', 'sibsp': 'sibsp', 'pclass': 'pclass', 'embarked':
    'embarked', 'fare': 'fare', 'body': 'body', 'ticket': 'ticket', 'age':
    'age', 'boat': 'boat', 'cabin': 'cabin', 'sex': 'sex', 'home.dest':
    'home.dest', 'parch': 'parch'}, 'survived')`
