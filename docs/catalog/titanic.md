...
*   **Supervised keys** (See
    ...
    `({'age': 'age', 'ticket': 'ticket', 'home.dest': 'home.dest', 'name':
    'name', 'sex': 'sex', 'embarked': 'embarked', 'boat': 'boat', 'pclass':
    'pclass', 'sibsp': 'sibsp', 'parch': 'parch', 'cabin': 'cabin', 'body':
    'body', 'fare': 'fare'}, 'survived')`
