...
*   **Supervised keys** (See
    ...
    `({'home.dest': 'home.dest', 'age': 'age', 'boat': 'boat', 'sex': 'sex',
    'sibsp': 'sibsp', 'parch': 'parch', 'pclass': 'pclass', 'body': 'body',
    'embarked': 'embarked', 'fare': 'fare', 'cabin': 'cabin', 'ticket':
    'ticket', 'name': 'name'}, 'survived')`
