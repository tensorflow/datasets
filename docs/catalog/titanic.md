...
*   **Supervised keys** (See
    ...
    `({'cabin': 'cabin', 'boat': 'boat', 'parch': 'parch', 'name': 'name',
    'sibsp': 'sibsp', 'age': 'age', 'home.dest': 'home.dest', 'body': 'body',
    'fare': 'fare', 'ticket': 'ticket', 'embarked': 'embarked', 'pclass':
    'pclass', 'sex': 'sex'}, 'survived')`
