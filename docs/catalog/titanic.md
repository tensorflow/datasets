...
*   **Supervised keys** (See
    ...
    `({'embarked': 'embarked', 'sex': 'sex', 'sibsp': 'sibsp', 'name': 'name',
    'parch': 'parch', 'cabin': 'cabin', 'home.dest': 'home.dest', 'ticket':
    'ticket', 'boat': 'boat', 'pclass': 'pclass', 'fare': 'fare', 'body':
    'body', 'age': 'age'}, 'survived')`
