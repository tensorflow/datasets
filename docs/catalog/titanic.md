...
*   **Supervised keys** (See
    ...
    `({'body': 'body', 'name': 'name', 'ticket': 'ticket', 'sibsp': 'sibsp',
    'home.dest': 'home.dest', 'fare': 'fare', 'parch': 'parch', 'pclass':
    'pclass', 'boat': 'boat', 'age': 'age', 'embarked': 'embarked', 'sex':
    'sex', 'cabin': 'cabin'}, 'survived')`
