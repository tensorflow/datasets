...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'cabin': 'cabin', 'sex': 'sex', 'body': 'body',
    'embarked': 'embarked', 'ticket': 'ticket', 'age': 'age', 'sibsp': 'sibsp',
    'fare': 'fare', 'home.dest': 'home.dest', 'parch': 'parch', 'pclass':
    'pclass', 'name': 'name'}, 'survived')`
