...
*   **Supervised keys** (See
    ...
    `({'sibsp': 'sibsp', 'age': 'age', 'boat': 'boat', 'sex': 'sex', 'fare':
    'fare', 'name': 'name', 'embarked': 'embarked', 'ticket': 'ticket',
    'pclass': 'pclass', 'home.dest': 'home.dest', 'parch': 'parch', 'body':
    'body', 'cabin': 'cabin'}, 'survived')`
