...
*   **Supervised keys** (See
    ...
    `({'pclass': 'pclass', 'age': 'age', 'home.dest': 'home.dest', 'name':
    'name', 'sex': 'sex', 'fare': 'fare', 'embarked': 'embarked', 'parch':
    'parch', 'ticket': 'ticket', 'sibsp': 'sibsp', 'boat': 'boat', 'cabin':
    'cabin', 'body': 'body'}, 'survived')`
