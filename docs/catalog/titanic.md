...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'body': 'body', 'fare': 'fare', 'age': 'age', 'pclass':
    'pclass', 'parch': 'parch', 'name': 'name', 'sibsp': 'sibsp', 'ticket':
    'ticket', 'cabin': 'cabin', 'home.dest': 'home.dest', 'embarked':
    'embarked', 'sex': 'sex'}, 'survived')`
