...
*   **Supervised keys** (See
    ...
    `({'home.dest': 'home.dest', 'fare': 'fare', 'age': 'age', 'pclass':
    'pclass', 'sex': 'sex', 'body': 'body', 'boat': 'boat', 'embarked':
    'embarked', 'ticket': 'ticket', 'sibsp': 'sibsp', 'name': 'name', 'cabin':
    'cabin', 'parch': 'parch'}, 'survived')`
