...
*   **Supervised keys** (See
    ...
    `({'sibsp': 'sibsp', 'home.dest': 'home.dest', 'body': 'body', 'name':
    'name', 'sex': 'sex', 'cabin': 'cabin', 'pclass': 'pclass', 'boat': 'boat',
    'embarked': 'embarked', 'parch': 'parch', 'ticket': 'ticket', 'fare':
    'fare', 'age': 'age'}, 'survived')`
