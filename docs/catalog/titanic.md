...
*   **Supervised keys** (See
    ...
    `({'body': 'body', 'sex': 'sex', 'age': 'age', 'cabin': 'cabin',
    'home.dest': 'home.dest', 'name': 'name', 'pclass': 'pclass', 'fare':
    'fare', 'sibsp': 'sibsp', 'embarked': 'embarked', 'parch': 'parch',
    'ticket': 'ticket', 'boat': 'boat'}, 'survived')`
