...
*   **Supervised keys** (See
    ...
    `({'sibsp': 'sibsp', 'fare': 'fare', 'cabin': 'cabin', 'home.dest':
    'home.dest', 'boat': 'boat', 'pclass': 'pclass', 'embarked': 'embarked',
    'age': 'age', 'parch': 'parch', 'ticket': 'ticket', 'sex': 'sex', 'name':
    'name', 'body': 'body'}, 'survived')`
