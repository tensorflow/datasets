...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'embarked': 'embarked', 'cabin': 'cabin', 'ticket':
    'ticket', 'name': 'name', 'parch': 'parch', 'sex': 'sex', 'body': 'body',
    'pclass': 'pclass', 'fare': 'fare', 'sibsp': 'sibsp', 'home.dest':
    'home.dest', 'age': 'age'}, 'survived')`
