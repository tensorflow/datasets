...
*   **Supervised keys** (See
    ...
    `({'embarked': 'embarked', 'parch': 'parch', 'pclass': 'pclass', 'cabin':
    'cabin', 'age': 'age', 'sex': 'sex', 'name': 'name', 'home.dest':
    'home.dest', 'sibsp': 'sibsp', 'fare': 'fare', 'body': 'body', 'boat':
    'boat', 'ticket': 'ticket'}, 'survived')`
