...
*   **Supervised keys** (See
    ...
    `({'age': 'age', 'fare': 'fare', 'ticket': 'ticket', 'embarked': 'embarked',
    'cabin': 'cabin', 'pclass': 'pclass', 'sex': 'sex', 'home.dest':
    'home.dest', 'sibsp': 'sibsp', 'boat': 'boat', 'body': 'body', 'parch':
    'parch', 'name': 'name'}, 'survived')`
