...
*   **Supervised keys** (See
    ...
    `({'age': 'age', 'pclass': 'pclass', 'cabin': 'cabin', 'body': 'body',
    'home.dest': 'home.dest', 'parch': 'parch', 'boat': 'boat', 'embarked':
    'embarked', 'ticket': 'ticket', 'sex': 'sex', 'fare': 'fare', 'name':
    'name', 'sibsp': 'sibsp'}, 'survived')`
