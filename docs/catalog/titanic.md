...
*   **Supervised keys** (See
    ...
    `({'ticket': 'ticket', 'parch': 'parch', 'sex': 'sex', 'name': 'name',
    'embarked': 'embarked', 'pclass': 'pclass', 'body': 'body', 'home.dest':
    'home.dest', 'boat': 'boat', 'cabin': 'cabin', 'fare': 'fare', 'sibsp':
    'sibsp', 'age': 'age'}, 'survived')`
