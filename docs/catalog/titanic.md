...
*   **Supervised keys** (See
    ...
    `({'body': 'body', 'pclass': 'pclass', 'embarked': 'embarked', 'fare':
    'fare', 'ticket': 'ticket', 'cabin': 'cabin', 'parch': 'parch', 'name':
    'name', 'sex': 'sex', 'age': 'age', 'sibsp': 'sibsp', 'home.dest':
    'home.dest', 'boat': 'boat'}, 'survived')`
