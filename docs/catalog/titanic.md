...
*   **Supervised keys** (See
    ...
    `({'sibsp': 'sibsp', 'name': 'name', 'cabin': 'cabin', 'ticket': 'ticket',
    'embarked': 'embarked', 'pclass': 'pclass', 'body': 'body', 'parch':
    'parch', 'boat': 'boat', 'fare': 'fare', 'age': 'age', 'home.dest':
    'home.dest', 'sex': 'sex'}, 'survived')`
