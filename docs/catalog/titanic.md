...
*   **Supervised keys** (See
    ...
    `({'parch': 'parch', 'boat': 'boat', 'ticket': 'ticket', 'age': 'age',
    'cabin': 'cabin', 'name': 'name', 'body': 'body', 'sibsp': 'sibsp',
    'embarked': 'embarked', 'home.dest': 'home.dest', 'fare': 'fare', 'sex':
    'sex', 'pclass': 'pclass'}, 'survived')`
