...
*   **Supervised keys** (See
    ...
    `({'home.dest': 'home.dest', 'age': 'age', 'sex': 'sex', 'sibsp': 'sibsp',
    'name': 'name', 'pclass': 'pclass', 'ticket': 'ticket', 'embarked':
    'embarked', 'fare': 'fare', 'body': 'body', 'parch': 'parch', 'boat':
    'boat', 'cabin': 'cabin'}, 'survived')`
