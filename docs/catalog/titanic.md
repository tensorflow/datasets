...
*   **Supervised keys** (See
    ...
    `({'cabin': 'cabin', 'sex': 'sex', 'embarked': 'embarked', 'name': 'name',
    'pclass': 'pclass', 'age': 'age', 'home.dest': 'home.dest', 'parch':
    'parch', 'boat': 'boat', 'ticket': 'ticket', 'sibsp': 'sibsp', 'fare':
    'fare', 'body': 'body'}, 'survived')`
