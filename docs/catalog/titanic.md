...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'ticket': 'ticket', 'body': 'body', 'home.dest':
    'home.dest', 'age': 'age', 'pclass': 'pclass', 'parch': 'parch', 'sex':
    'sex', 'embarked': 'embarked', 'cabin': 'cabin', 'sibsp': 'sibsp', 'fare':
    'fare', 'name': 'name'}, 'survived')`
