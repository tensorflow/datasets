...
*   **Supervised keys** (See
    ...
    `({'cabin': 'cabin', 'name': 'name', 'age': 'age', 'embarked': 'embarked',
    'body': 'body', 'fare': 'fare', 'parch': 'parch', 'pclass': 'pclass',
    'ticket': 'ticket', 'sibsp': 'sibsp', 'home.dest': 'home.dest', 'boat':
    'boat', 'sex': 'sex'}, 'survived')`
