...
*   **Supervised keys** (See
    ...
    `({'cabin': 'cabin', 'boat': 'boat', 'name': 'name', 'parch': 'parch',
    'sex': 'sex', 'home.dest': 'home.dest', 'pclass': 'pclass', 'ticket':
    'ticket', 'body': 'body', 'age': 'age', 'embarked': 'embarked', 'sibsp':
    'sibsp', 'fare': 'fare'}, 'survived')`
