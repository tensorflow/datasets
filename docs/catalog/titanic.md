...
*   **Supervised keys** (See
    ...
    `({'fare': 'fare', 'embarked': 'embarked', 'name': 'name', 'parch': 'parch',
    'sex': 'sex', 'cabin': 'cabin', 'ticket': 'ticket', 'sibsp': 'sibsp',
    'boat': 'boat', 'body': 'body', 'home.dest': 'home.dest', 'pclass':
    'pclass', 'age': 'age'}, 'survived')`
