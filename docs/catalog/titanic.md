...
*   **Supervised keys** (See
    ...
    `({'fare': 'fare', 'embarked': 'embarked', 'ticket': 'ticket', 'pclass':
    'pclass', 'body': 'body', 'age': 'age', 'name': 'name', 'home.dest':
    'home.dest', 'cabin': 'cabin', 'sibsp': 'sibsp', 'sex': 'sex', 'parch':
    'parch', 'boat': 'boat'}, 'survived')`
