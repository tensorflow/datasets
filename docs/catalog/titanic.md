...
*   **Supervised keys** (See
    ...
    `({'body': 'body', 'cabin': 'cabin', 'age': 'age', 'fare': 'fare',
    'embarked': 'embarked', 'name': 'name', 'sex': 'sex', 'pclass': 'pclass',
    'parch': 'parch', 'ticket': 'ticket', 'boat': 'boat', 'home.dest':
    'home.dest', 'sibsp': 'sibsp'}, 'survived')`
