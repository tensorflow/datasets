...
*   **Supervised keys** (See
    ...
    `({'home.dest': 'home.dest', 'age': 'age', 'boat': 'boat', 'pclass':
    'pclass', 'name': 'name', 'embarked': 'embarked', 'cabin': 'cabin', 'sex':
    'sex', 'ticket': 'ticket', 'parch': 'parch', 'fare': 'fare', 'sibsp':
    'sibsp', 'body': 'body'}, 'survived')`
