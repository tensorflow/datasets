...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'age': 'age', 'fare': 'fare', 'sibsp': 'sibsp',
    'embarked': 'embarked', 'name': 'name', 'parch': 'parch', 'ticket':
    'ticket', 'sex': 'sex', 'body': 'body', 'pclass': 'pclass', 'home.dest':
    'home.dest', 'cabin': 'cabin'}, 'survived')`
