...
*   **Supervised keys** (See
    ...
    `({'age': 'age', 'cabin': 'cabin', 'parch': 'parch', 'sibsp': 'sibsp',
    'home.dest': 'home.dest', 'embarked': 'embarked', 'name': 'name', 'body':
    'body', 'boat': 'boat', 'pclass': 'pclass', 'fare': 'fare', 'sex': 'sex',
    'ticket': 'ticket'}, 'survived')`
