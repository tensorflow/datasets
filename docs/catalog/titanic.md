...
*   **Supervised keys** (See
    ...
    `({'home.dest': 'home.dest', 'boat': 'boat', 'parch': 'parch', 'fare':
    'fare', 'age': 'age', 'sex': 'sex', 'sibsp': 'sibsp', 'embarked':
    'embarked', 'pclass': 'pclass', 'name': 'name', 'body': 'body', 'ticket':
    'ticket', 'cabin': 'cabin'}, 'survived')`
