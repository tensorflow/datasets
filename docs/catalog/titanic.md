...
*   **Supervised keys** (See
    ...
    `({'pclass': 'pclass', 'boat': 'boat', 'name': 'name', 'parch': 'parch',
    'body': 'body', 'sibsp': 'sibsp', 'ticket': 'ticket', 'cabin': 'cabin',
    'embarked': 'embarked', 'age': 'age', 'home.dest': 'home.dest', 'sex':
    'sex', 'fare': 'fare'}, 'survived')`
