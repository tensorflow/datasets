...
*   **Supervised keys** (See
    ...
    `({'parch': 'parch', 'cabin': 'cabin', 'embarked': 'embarked', 'boat':
    'boat', 'sibsp': 'sibsp', 'home.dest': 'home.dest', 'age': 'age', 'ticket':
    'ticket', 'pclass': 'pclass', 'fare': 'fare', 'body': 'body', 'name':
    'name', 'sex': 'sex'}, 'survived')`
