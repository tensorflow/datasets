...
*   **Supervised keys** (See
    ...
    `({'sibsp': 'sibsp', 'sex': 'sex', 'body': 'body', 'parch': 'parch',
    'home.dest': 'home.dest', 'name': 'name', 'ticket': 'ticket', 'boat':
    'boat', 'cabin': 'cabin', 'fare': 'fare', 'embarked': 'embarked', 'age':
    'age', 'pclass': 'pclass'}, 'survived')`
