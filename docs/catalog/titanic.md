...
*   **Supervised keys** (See
    ...
    `({'boat': 'boat', 'ticket': 'ticket', 'name': 'name', 'embarked':
    'embarked', 'sex': 'sex', 'body': 'body', 'sibsp': 'sibsp', 'cabin':
    'cabin', 'home.dest': 'home.dest', 'pclass': 'pclass', 'fare': 'fare',
    'parch': 'parch', 'age': 'age'}, 'survived')`
