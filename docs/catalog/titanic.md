...
*   **Supervised keys** (See
    ...
    `({'body': 'body', 'boat': 'boat', 'sibsp': 'sibsp', 'fare': 'fare',
    'embarked': 'embarked', 'parch': 'parch', 'sex': 'sex', 'name': 'name',
    'age': 'age', 'home.dest': 'home.dest', 'ticket': 'ticket', 'cabin':
    'cabin', 'pclass': 'pclass'}, 'survived')`
