...
*   **Supervised keys** (See
    ...
    `({'sibsp': 'sibsp', 'ticket': 'ticket', 'cabin': 'cabin', 'body': 'body',
    'boat': 'boat', 'name': 'name', 'age': 'age', 'home.dest': 'home.dest',
    'parch': 'parch', 'embarked': 'embarked', 'pclass': 'pclass', 'fare':
    'fare', 'sex': 'sex'}, 'survived')`
