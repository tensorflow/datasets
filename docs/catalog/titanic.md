...
*   **Supervised keys** (See
    ...
    `({'cabin': 'cabin', 'sex': 'sex', 'parch': 'parch', 'body': 'body',
    'sibsp': 'sibsp', 'home.dest': 'home.dest', 'boat': 'boat', 'embarked':
    'embarked', 'ticket': 'ticket', 'name': 'name', 'age': 'age', 'pclass':
    'pclass', 'fare': 'fare'}, 'survived')`
