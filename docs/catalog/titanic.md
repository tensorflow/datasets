...
*   **Supervised keys** (See
    ...
    `({'cabin': 'cabin', 'body': 'body', 'pclass': 'pclass', 'embarked':
    'embarked', 'boat': 'boat', 'sibsp': 'sibsp', 'age': 'age', 'ticket':
    'ticket', 'name': 'name', 'sex': 'sex', 'home.dest': 'home.dest', 'fare':
    'fare', 'parch': 'parch'}, 'survived')`
