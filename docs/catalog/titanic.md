...
*   **Supervised keys** (See
    ...
    `({'body': 'body', 'home.dest': 'home.dest', 'boat': 'boat', 'embarked':
    'embarked', 'cabin': 'cabin', 'sibsp': 'sibsp', 'parch': 'parch', 'fare':
    'fare', 'pclass': 'pclass', 'name': 'name', 'ticket': 'ticket', 'sex':
    'sex', 'age': 'age'}, 'survived')`
