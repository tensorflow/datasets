...
| steps                         | Dataset      |         |         |                                                              |
| steps/action                  | Tensor       | (8,)    | float32 | Robot action, consists of [3x end-effector position, 4x      |
:                               :              :         :         : end-effector quaternion, 1x gripper open/close].             :
...
| steps/observation/image       | Image        | (360,   | uint8   | Main camera RGB observation.                                 |
:                               :              : 640, 3) :         :                                                              :
| steps/observation/state       | Tensor       | (20,)   | float32 | Robot state, consists of [7x robot joint angles, 1x gripper  |
:                               :              :         :         : status, 6x joint torques, 6x end-effector force].            :
