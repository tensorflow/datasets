...
*   **Additional Documentation**:
    <a class="button button-with-icon" href="https://paperswithcode.com/dataset/mnist">
...
<script>
const url = "https://storage.googleapis.com/tfds-data/visualization/dataframe/mnist-3.0.1.html";
