...
<script>
var url = "https://storage.googleapis.com/tfds-data/visualization/dataframe/wit_kaggle-train_with_extended_features-1.0.0.html";
$(document).ready(() => {
...
<img src="https://storage.googleapis.com/tfds-data/visualization/fig/wit_kaggle-test_without_gold-1.0.0.png" alt="Visualization" width="500px">
...
<script src="https://www.gstatic.com/external_hosted/jquery2.min.js"></script>
<script>
var url = "https://storage.googleapis.com/tfds-data/visualization/dataframe/wit_kaggle-test_without_gold-1.0.0.html";
$(document).ready(() => {
  $("#displaydataframe").click((event) => {
    // Disable the button after clicking (dataframe loaded only once).
    $("#displaydataframe").prop("disabled", true);
