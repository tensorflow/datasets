...
*   `boolq` (`v1.0.1`) (`Size: 3.93 MiB`): BoolQ (Boolean Questions, Clark et
...
*   `cb` (`v1.0.1`) (`Size: 73.71 KiB`): The CommitmentBank (De Marneffe et al.,
...
*   `copa` (`v1.0.1`) (`Size: 42.96 KiB`): The Choice Of Plausible Alternatives
...
*   `multirc` (`v1.0.1`) (`Size: 1.06 MiB`): The Multi-Sentence Reading
...
*   `record` (`v1.0.1`) (`Size: 49.36 MiB`): (Reading Comprehension with
...
*   `rte` (`v1.0.1`) (`Size: 733.32 KiB`): The Recognizing Textual Entailment
...
*   `wic` (`v1.0.1`) (`Size: 386.93 KiB`): The Word-in-Context (WiC, Pilehvar
...
*   `wsc` (`v1.0.1`) (`Size: 31.98 KiB`): The Winograd Schema Challenge (WSC,
...
*   `wsc.fixed` (`v1.0.1`) (`Size: 31.98 KiB`): The Winograd Schema Challenge
