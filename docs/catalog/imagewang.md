...
*   `full-size` (`v2.0.0`) (`Size: ?? GiB`): Imagewang contains Imagenette and
    Imagewoof combined.

*   `320px` (`v2.0.0`) (`Size: ?? GiB`): Imagewang contains Imagenette and
    Imagewoof combined.

*   `160px` (`v2.0.0`) (`Size: ?? GiB`): Imagewang contains Imagenette and
    Imagewoof combined.
