...
from tensorflow_datasets.datasets.wiki_table_questions import wiki_table_questions_dataset_builder


class WikiTableQuestionsTest(tfds.testing.DatasetBuilderTestCase):
  """Tests for wiki_table_questions dataset."""

  DATASET_CLASS = wiki_table_questions_dataset_builder.Builder
  SPLITS = {
      'train': 2,
      'split-1-train': 1,
      'split-1-dev': 1,
  ...
  def test_generate_examples(self):
    ...
    with mock.patch.object(
      ...
      dataset = {dataset_name}_dataset_builder.WikiTableQuestions()
