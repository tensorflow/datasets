...
from tensorflow_datasets.datasets.web_nlg import web_nlg_dataset_builder


class WebNlgTest(tfds.testing.DatasetBuilderTestCase):
  DATASET_CLASS = web_nlg_dataset_builder.Builder
  SPLITS = {
      'train': 12,
      'validation': 4,
      'test_all': 5,
  ...
  def test_generate_examples(self, parse_mock):
    ...
    dataset = {dataset_name}_dataset_builder.WebNlg()
