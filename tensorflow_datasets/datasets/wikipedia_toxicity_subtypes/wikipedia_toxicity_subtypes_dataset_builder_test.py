...
from tensorflow_datasets.datasets.wikipedia_toxicity_subtypes import wikipedia_toxicity_subtypes_dataset_builder
import tensorflow_datasets.public_api as tfds


class WikipediaToxicitySubtypesTest(tfds.testing.DatasetBuilderTestCase):
  DATASET_CLASS = wikipedia_toxicity_subtypes_dataset_builder.Builder
