...
from tensorflow_datasets.datasets.web_graph import web_graph_dataset_builder


class WebGraphTest(tfds.testing.DatasetBuilderTestCase):
  """Tests for web_graph dataset."""

  DATASET_CLASS = web_graph_dataset_builder.Builder
  SPLITS = {
  ...
  @classmethod
  def setUpClass(cls):
    {dataset_name}_dataset_builder.WebGraph.WEB_GRAPH_HOMEPAGE = cls.dummy_data
    {dataset_name}_dataset_builder.WebGraph.SHARDS = 1
    super().setUpClass()
