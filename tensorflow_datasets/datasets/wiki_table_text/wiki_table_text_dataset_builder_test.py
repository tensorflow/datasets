...
from tensorflow_datasets.datasets.wiki_table_text import wiki_table_text_dataset_builder


class WikiTableTextTest(tfds.testing.DatasetBuilderTestCase):
  """Tests for wiki_table_text dataset."""

  DATASET_CLASS = wiki_table_text_dataset_builder.Builder
  SPLITS = {
      'train': 4,
      'validation': 2,
      'test': 3,
  ...
  def test_generate_examples(self):
    ...
    dataset = {dataset_name}_dataset_builder.WikiTableText()
