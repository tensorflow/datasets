...
from tensorflow_datasets.datasets.squad_question_generation import squad_question_generation_dataset_builder
...
class SquadQuestionGenerationSplitDuTest(tfds.testing.DatasetBuilderTestCase):
  ...
  DATASET_CLASS = squad_question_generation_dataset_builder.Builder
  SPLITS = {
