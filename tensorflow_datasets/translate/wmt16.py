...
class Wmt16Translate(wmt.WmtTranslate):
  ...
  def _subsets(self):
    return {
        ...
        tfds.Split.VALIDATION: ["newsdev2016", "newstest2015"],  # pyrefly: ignore[missing-attribute]
        tfds.Split.TEST: ["newstest2016", "newstestB2016"],  # pyrefly: ignore[missing-attribute]
    }
