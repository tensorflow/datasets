...
class Medical(tfds.core.GeneratorBasedBuilder):
  """TODO(medical): Short description of my dataset."""

  # TODO(medical): Set up version.
  VERSION = tfds.core.Version('0.1.0')

  def _info(self):
    # TODO(medical): Specifies the tfds.core.DatasetInfo object
