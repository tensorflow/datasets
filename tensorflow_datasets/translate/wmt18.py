...
class Wmt18Translate(wmt.WmtTranslate):
  ...
  def _subsets(self):
    return {
        ...
        tfds.Split.VALIDATION: ["newsdev2018", "newstest2017", "newstestB2017"],  # pyrefly: ignore[missing-attribute]
        tfds.Split.TEST: ["newstest2018"],  # pyrefly: ignore[missing-attribute]
    }
