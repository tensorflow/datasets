...
from tensorflow_datasets.core.utils import lazy_module_utils

# pylint: disable=g-import-not-at-top,g-importing-member
with lazy_module_utils.lazy_module(
    globals(), context_manager=registered.skip_registration
):
...
del lazy_module_utils, registered
