...
@misc{11234/1-4758,
 ...
 Aleksandravi{v c}i{=u}te, Gabriele and Alfina, Ika and Algom, Avner \
 and Andersen, Erik and Antonsen, Lene and Aplonova, Katya and Aquino, \
 Angelina and Aragon, Carolina and Aranes, Glyd and Aranzabe, Maria Jesus and \
 Arican, Bilge Nas and Arnard{\'o}ttir, {\t H}{\'o}runn and Arutie, Gashaw \
 and Arwidarasti, Jessica Naraiswari and Asahara, Masayuki and Aslan, Deniz \
 Baran and Asmazoglu, Cengiz and Ateyah, Luma and Atmaca, Furkan and \
 Attia, Mohammed and Atutxa, Aitziber and Augustinus, Liesbeth and Badmaeva, \
 Elena and Balasubramani, Keerthana and Ballesteros, Miguel and Banerjee, \
 Esha and Bank, Sebastian and Barbu Mititelu, Verginica and Barkarson, \
 Starkaður and Basile, Rodolfo and Basmov, Victoria and Batchelor, Colin and \
 Bauer, John and Bedir, Seyyit Talha and Bengoetxea, Kepa and Ben Moshe, Yifat \
 and Berk, G{\"o}zde and Berzak, Yevgeni and Bhat, Irshad Ahmad and Bhat, \
 Riyaz Ahmad and Biagetti, Erica and Bick, Eckhard and Bielinskiene, \
 Agne and Bjarnad{\'o}ttir, Krist{\'i}n and Blokland, Rogier and \
 Bobicev, Victoria and Boizou, Lo{\"i}c and Borges V{\"o}lker, Emanuel \
 and B{\"o}rstell, Carl and Bosco, Cristina and Bouma, Gosse and Bowman, Sam \
 and Boyd, Adriane and Braggaar, Anouck and Brokaite, Kristina and \
 Burchardt, Aljoscha and Candito, Marie and Caron, Bernard and Caron, Gauthier \
 and Cassidy, Lauren and Cavalcanti, Tatiana and Cebiroglu Eryigit, \
 G{\"u}l{s}en and Cecchini, Flavio Massimiliano and Celano, Giuseppe G. A. \
 and {C}{\'e}pl{\"o}, Slavom{\'i}r and Cesur, Neslihan and Cetin, Savas \
 and {C}etinoglu, {\"O}zlem and Chalub, Fabricio and Chauhan, Shweta \
 and Chi, Ethan and Chika, Taishi and Cho, Yongseok and Choi, Jinho and Chun, \
 Jayeol and Chung, Juyeon and Cignarella, Alessandra T. and Cinkov{\'a}, \
 Silvie and Collomb, Aur{\'e}lie and {C}{\"o}ltekin, {C}a{g}ri and \
 Connor, Miriam and Corbetta, Daniela and Courtin, Marine and Cristescu, \
 Mihaela and Daniel, Philemon and Davidson, Elizabeth and Dehouck, Mathieu \
 and de Laurentiis, Martina and de Marneffe, Marie-Catherine and de Paiva, \
 Valeria and Derin, Mehmet Oguz and de Souza, Elvis and Diaz de Ilarraza, \
 Arantza and Dickerson, Carly and Dinakaramani, Arawinda and Di Nuovo, Elisa \
 and Dione, Bamba and Dirix, Peter and Dobrovoljc, Kaja and Dozat, Timothy and \
 Droganova, Kira and Dwivedi, Puneet and Eckhoff, Hanne and Eiche, Sandra and \
 Eli, Marhaba and Elkahky, Ali and Ephrem, Binyam and Erina, Olga and Erjavec, \
 Toma{v z} and Etienne, Aline and Evelyn, Wograine and Facundes, Sidney and \
 Farkas, Rich{\'a}rd and Favero, Federica and Ferdaousi, Jannatul and \
 Fernanda, Mar{\'i}lia and Fernandez Alcalde, Hector and Foster, Jennifer \
 and Freitas, Cl{\'a}udia and Fujita, Kazunori and Gajdo{v s}ov{\'a}, \
 Katar{\'i}na and Galbraith, Daniel and Gamba, Federica and Garcia, Marcos \
 and G{\"a}rdenfors, Moa and Garza, Sebastian and Gerardi, Fabr{\'i}cio \
 Ferraz and Gerdes, Kim and Ginter, Filip and Godoy, Gustavo and Goenaga, \
 Iakes and Gojenola, Koldo and G{\"o}kirmak, Memduh and Goldberg, Yoav and \
 G{\'o}mez Guinovart, Xavier and Gonz{\'a}lez Saavedra, Berta and \
 Griciute, Bernadeta and Grioni, Matias and Grobol, Lo{\"i}c and \
 Gruzitis, Normunds and Guillaume, Bruno and Guillot-Barbance, \
 C{\'e}line and G{\"u}ng{\"o}r, Tunga and Habash, Nizar and Hafsteinsson, \
 Hinrik and Hajic, Jan and Hajic jr., Jan and \
 H{\"a}m{\"a}l{\"a}inen, Mika and Ha My, Linh and Han, Na-Rae and \
 Hanifmuti, Muhammad Yudistira and Harada, Takahiro and Hardwick, Sam and \
 Harris, Kim and Haug, Dag and Heinecke, Johannes and Hellwig, Oliver and \
 Hennig, Felix and Hladk{\'a}, Barbora and Hlav{\'a}{v c}ov{\'a}, Jaroslava \
 and Hociung, Florinel and Hohle, Petter and Hwang, Jena and Ikeda, Takumi \
 and Ingason, Anton Karl and Ion, Radu and Irimia, Elena and Ishola, \
 {O}l{\'a}j{\'i}d{\'e} and Ito, Kaoru and Jannat, Siratun and \
 Jel{\'i}nek, Tom{\'a}{v s} and Jha, Apoorva and Johannsen, Anders and \
 J{\'o}nsd{\'o}ttir, Hildur and Jorgensen, Fredrik and Juutinen, Markus \
 and K, Sarveswaran and Ka{c s}ikara, H{\"u}ner and Kaasen, Andre and \
 Kabaeva, Nadezhda and Kahane, Sylvain and Kanayama, Hiroshi and Kanerva, \
 Jenna and Kara, Neslihan and Karah{\'o}ǧa, Ritv{\'a}n and Katz, Boris and \
 Kayadelen, Tolga and Kenney, Jessica and Kettnerov{\'a}, V{\'a}clava and \
 Kirchner, Jesse and Klementieva, Elena and Klyachko, Elena and K{\"o}hn, \
 Arne and K{\"o}ksal, Abdullatif and Kopacewicz, Kamil and Korkiakangas, Timo \
 and K{\"o}se, Mehmet and Kotsyba, Natalia and Kovalevskaite, Jolanta and \
 Krek, Simon and Krishnamurthy, Parameswari and K{\"u}bler, Sandra and \
 Kuyruk{c c}u, O{g}uzhan and Kuzgun, Asli and Kwak, Sookyoung and \
 Laippala, Veronika and Lam, Lucia and Lambertino, Lorenzo and Lando, Tatiana \
 and Larasati, Septina Dian and Lavrentiev, Alexei and Lee, John and Le \
 H{o}ng, Phương and Lenci, Alessandro and Lertpradit, Saran and Leung, \
 Herman and Levina, Maria and Li, Cheuk Ying and Li, Josie and Li, Keying and \
 Li, Yuan and Lim, {KyungTae} and Lima Padovani, Bruna and Lind{\'e}n, Krister \
 and Ljube{s}i{\'c}, Nikola and Loginova, Olga and Lusito, Stefano and \
 Luthfi, Andry and Luukko, Mikko and Lyashevskaya, Olga and Lynn, Teresa and \
 Macketanz, Vivien and Mahamdi, Menel and Maillard, Jean and Makazhanov, Aibek \
 and Mandl, Michael and Manning, Christopher and Manurung, Ruli and \
 Mar{s}an, B{\"u}{s}ra and M{a}r{a}nduc, C{a}t{a}lina and \
 Mare{c}ek, David and Marheinecke, Katrin and Markantonatou, Stella and \
 Mart{\'i}nez Alonso, H{\'e}ctor and Mart{\'i}n Rodr{\'i}guez, Lorena \
 and Martins, Andr{\'e} and Ma{s}ek, Jan and Matsuda, Hiroshi and \
 Matsumoto, Yuji and Mazzei, Alessandro and {McDonald}, Ryan and {McGuinness}, \
 Sarah and Mendon{c}a, Gustavo and Merzhevich, Tatiana and Miekka, Niko and \
 Mischenkova, Karina and Misirpashayeva, Margarita and Missil{\"a}, Anna and \
 Mititelu, C{a}t{a}lin and Mitrofan, Maria and Miyao, Yusuke and Mojiri \
 Foroushani, {AmirHossein} and Moln{\'a}r, Judit and Moloodi, Amirsaeid and \
 Montemagni, Simonetta and More, Amir and Moreno Romero, Laura and Moretti, \
 Giovanni and Mori, Keiko Sophie and Mori, Shinsuke and Morioka, Tomohiko and \
 Moro, Shigeki and Mortensen, Bjartur and Moskalevskyi, Bohdan and Muischnek, \
 Kadri and Munro, Robert and Murawaki, Yugo and M{\"u}{\"u}risep, Kaili and \
 Nainwani, Pinkey and Nakhl{\'e}, Mariam and Navarro Horniacek, Juan \
 Ignacio and Nedoluzhko, Anna and Ne{v s}pore-Berzkalne, Gunta and \
 Nevaci, Manuela and Nguy{e}n Th{i}, Lương and Nguy{e}n \
 Th{i} Minh, Huy{e}n and Nikaido, Yoshihiro and Nikolaev, Vitaly \
 and Nitisaroj, Rattima and Nourian, Alireza and Nurmi, Hanna and Ojala, \
 Stina and Ojha, Atul Kr. and Ol{\'u}{\'o}kun, Ad{e}day{o}̀ and Omura, \
 Mai and Onwuegbuzia, Emeka and Ordan, Noam and Osenova, Petya and \
 {\"O}stling, Robert and {O}vrelid, Lilja and {\"O}zate{s}, \
 {S}aziye Bet{\"u}l and {\"O}z{c}elik, Merve and {\"O}zg{\"u}r, \
 Arzucan and {\"O}zt{\"u}rk Ba{s}aran, Balkiz and Paccosi, Teresa \
 and Palmero Aprosio, Alessio and Park, Hyunji Hayley and Partanen, Niko \
 and Pascual, Elena and Passarotti, Marco and Patejuk, Agnieszka and \
 Paulino-Passos, Guilherme and Pedonese, Giulia and Peljak-{L}api{n}ska, \
 Angelika and Peng, Siyao and Perez, Cenel-Augusto and Perkova, Natalia and \
 Perrier, Guy and Petrov, Slav and Petrova, Daria and Peverelli, Andrea and \
 Phelan, Jason and Piitulainen, Jussi and Pirinen, Tommi A and Pitler, Emily \
 and Plank, Barbara and Poibeau, Thierry and Ponomareva, Larisa and Popel, \
 Martin and Pretkalni{n}a, Lauma and Pr{\'e}vost, Sophie and Prokopidis, \
 Prokopis and Przepi{o}rkowski, Adam and Puolakainen, Tiina and Pyysalo, \
 Sampo and Qi, Peng and R{\"a}{\"a}bis, Andriela and Rademaker, Alexandre and \
 Rahoman, Mizanur and Rama, Taraka and Ramasamy, Loganathan and Ramisch, \
 Carlos and Rashel, Fam and Rasooli, Mohammad Sadegh and Ravishankar, Vinit \
 and Real, Livy and Rebeja, Petru and Reddy, Siva and Regnault, Mathilde and \
 Rehm, Georg and Riabov, Ivan and Rie{ss}ler, Michael and Rimkut{e}, Erika \
 and Rinaldi, Larissa and Rituma, Laura and Rizqiyah, Putri and Rocha, Luisa \
 and R{\"o}gnvaldsson, Eir{\'i}kur and Romanenko, Mykhailo and Rosa, Rudolf \
 and Roșca, Valentin and Rovati, Davide and Rozonoyer, Ben and Rudina, Olga \
 and Rueter, Jack and R{\'u}narsson, Kristj{\'a}n and Sadde, Shoval and \
 Safari, Pegah and Sagot, Beno{i}t and Sahala, Aleksi and Saleh, Shadi \
 and Salomoni, Alessio and Samard{v z}i{\'c}, Tanja and Samson, Stephanie and \
 Sanguinetti, Manuela and Saniyar, Ezgi and S{\"a}rg, Dage and \
 Saulite, Baiba and Sawanakunanon, Yanin and Saxena, Shefali and \
 Scannell, Kevin and Scarlata, Salvatore and Schneider, Nathan and Schuster, \
 Sebastian and Schwartz, Lane and Seddah, Djam{\'e} and Seeker, Wolfgang and \
 Seraji, Mojgan and Shahzadi, Syeda and Shen, Mo and Shimada, Atsuko and \
 Shirasu, Hiroyuki and Shishkina, Yana and Shohibussirri, Muh and Sichinava, \
 Dmitry and Siewert, Janine and Sigurðsson, Einar Freyr and Silveira, Aline \
 and Silveira, Natalia and Simi, Maria and Simionescu, Radu and Simk{\'o}, \
 Katalin and {S}imkov{\'a}, M{\'a}ria and Simov, Kiril and Skachedubova, \
 Maria and Smith, Aaron and Soares-Bastos, Isabela and Sourov, Shafi and \
 Spadine, Carolyn and Sprugnoli, Rachele and Stamou, Vivian and \
 Steingr{\'i}msson, Stein{h}{\'o}r and Stella, Antonio and Straka, \
 Milan and Strickland, Emmett and Strnadov{\'a}, Jana and Suhr, Alane and \
 Sulestio, Yogi Lesmana and Sulubacak, Umut and Suzuki, Shingo and Swanson, \
 Daniel and Sz{\'a}nt{\'o}, Zsolt and Taguchi, Chihiro and Taji, Dima and \
 Takahashi, Yuta and Tamburini, Fabio and Tan, Mary Ann C. and Tanaka, Takaaki \
 and Tanaya, Dipta and Tavoni, Mirko and Tella, Samson and Tellier, Isabelle \
 and Testori, Marinella and Thomas, Guillaume and Tonelli, Sara and Torga, \
 Liisi and Toska, Marsida and Trosterud, Trond and Trukhina, Anna and \
 Tsarfaty, Reut and T{\"u}rk, Utku and Tyers, Francis and Uematsu, Sumire \
 and Untilov, Roman and Ure{v s}ov{\'a}, Zde{n}ka and Uria, Larraitz and \
 Uszkoreit, Hans and Utka, Andrius and Vagnoni, Elena and Vajjala, Sowmya and \
 van der Goot, Rob and Vanhove, Martine and van Niekerk, Daniel and van Noord, \
 Gertjan and Varga, Viktor and Vedenina, Uliana and Villemonte de la \
 Clergerie, Eric and Vincze, Veronika and Vlasova, Natalia and Wakasa, \
 Aya and Wallenberg, Joel C. and Wallin, Lars and Walsh, Abigail and Wang, \
 Jing Xian and Washington, Jonathan North and Wendt, Maximilan and Widmer, \
 Paul and Wigderson, Shira and Wijono, Sri Hartati and Williams, Seyi and \
 Wir{\'e}n, Mats and Wittern, Christian and Woldemariam, Tsegay and Wong, \
 Tak-sum and Wr{\'o}blewska, Alina and Yako, Mary and Yamashita, Kayo and \
 Yamazaki, Naoki and Yan, Chunxiao and Yasuoka, Koichi and Yavrumyan, Marat M. \
 and Yenice, Arife Bet{\"u}l and Yildiz, Olcay Taner and Yu, Zhuoran and \
 Yuliawati, Arlisa and {Z}abokrtsk{\'y}, Zden{v e}k and Zahra, Shorouq and \
 Zeldes, Amir and Zhou, He and Zhu, Hanzhi and Zhuravleva, Anna and Ziane, \
 Rayan
 },
