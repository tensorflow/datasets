...
from tensorflow_datasets.audio import userlibri_audio_data


class UserLibriAudioTest(testing.DatasetBuilderTestCase):
  DATASET_CLASS = userlibri_audio_data.UserLibriAudio
  EXAMPLE_DIR = testing.test_utils.fake_examples_dir()
  SPLITS = {
  ...
  DL_DOWNLOAD_RESULT = {"google/userlibri": "UserLibri"}
  SKIP_CHECKSUMS = True
