...
_DESCRIPTION = """\
LibriSpeech is a corpus of approximately 1000 hours of read English speech of frequency 16 KHz, prepared by Vassil 
Panayotov with the assistance of Daniel Povey. The data is derived from read audiobooks from the LibriVox
