...
_DESCRIPTION = ("The Stanford Dogs dataset contains images of 120 breeds of dogs from around the world."
                "This dataset has been built using images and annotation from ImageNet for the task of fine-grained image categorization."
                "There are 20,580 images, out of which 12,000 are used for training and 8580 for testing."
                "Class labels and bounding box annotations are provided for all the 12,000 images.")
...
class StanfordDogs(tfds.core.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, archive, file_names, annotation_files):
        ...
        Yields:
        Image path, Image file name, its corresponding label and bounding box values
        ...
        for fname, fobj in archive:
            ...
            if not res or not fname.split("/")[-1] in file_names:
                continue
            ...
            normalize_bbox = lambda bbox_side, image_side: bbox_side/image_side if bbox_side/image_side<=1 else 1.0
            ...
            yield {"image": fobj, 
                ...
                "objects": [{"bbox": build_box(attributes, n)} for n in range(len(attributes["xmin"]))]}
