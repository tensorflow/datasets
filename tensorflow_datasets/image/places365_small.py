...
_LABELS_FNAME = 'categories_places365.txt'
  ...
  def _generate_examples(self,data_dir_path,split_name):
        ...
        if split_name == 'test' or split_name == 'validation':
            ...
            for dir in tf.io.gfile.listdir(data_dir_path):
                ...
                for class_name in tf.io.gfile.listdir(alphabet_dir):
                    class_dir = os.path.join(alphabet_dir,class_name)
                    if fnmatch.fnmatch(class_name,"*.jpg"):
