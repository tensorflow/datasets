...
_DESCRIPTION = ("Caltech-UCSD Birds 200 (CUB-200) is an image dataset with photos of 200 bird species (mostly North American)."
                "The total number of categories of birds is 200 and there are 6033 images in the dataset."
...
class CaltechBirds2010(tfds.core.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, archive, file_names, annotations):
        ...
        annotations : dict of image file names and bbox attributes, segmentation labels
        ...
        for fname, fobj in archive:
            ...
            yield {"image": fobj, 
                ...
                "bbox": tfds.features.BBox(
                    ymin=normalize_bbox(annotations[file_name][0]["top"], height),
