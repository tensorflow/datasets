...
_DATASET_URL = "https://drive.google.com/uc?export=download&" \
               "id=0B7OEHD3T4eCkVGs0TkhUWFN6N1k"

_PROJECT_URL = "http://www.cbsr.ia.ac.cn/users/xiangyuzhu/" \
  ...
  def _info(self):
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            "shape_params": tfds.features.Tensor(shape=(199,),
                                                 dtype=tf.float32),
