...
_DESCRIPTION = """
The PlantVillage dataset consists of 55446 healthy and unhealthy leaf images
divided into 38 categories by species and disease.

NOTE: The original dataset is not available from the original source
(plantvillage.org), therefore we get the unaugmented original dataset from a
paper that used that dataset and republished it.
