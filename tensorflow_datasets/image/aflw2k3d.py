...
class Aflw2k3d(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self):
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            "landmarks_68_3d_xy_normalized": tfds.features.Tensor(shape=(68, 2), dtype=tf.float32),
            "landmarks_68_3d_z": tfds.features.Tensor(shape=(68, 1), dtype=tf.float32),
        }),
  ...
  def _generate_examples(self, image_dir_path):
    image_files = tf.io.gfile.glob(pattern=os.path.join(image_dir_path,"image0*.jpg"))
