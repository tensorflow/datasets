...
# (smartwatch_gestures): Markdown description appearing on the catalog page.
_DESCRIPTION = """
...
# (smartwatch_gestures): BibTeX citation
_CITATION = """
@INPROCEEDINGS{
  6952946,
...
class SmartwatchGestures(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    class_label = tfds.features.ClassLabel(
        names_file=tfds.core
        .tfds_path('time_series/smartwatch_gestures/class_labels.txt')
    )
    # (smartwatch_gestures): Specifies the tfds.core.DatasetInfo object
