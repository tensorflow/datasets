...
# TODO(grocery): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
This dataset contains the natural images of grocery items. All natural images was taken with a 
smartphone camera in different grocery stores. We ended up with 5125 natural images from 81 
different classes of fruits, vegetables, and carton items (e.g. juice, milk, yoghurt). The 81
classes are divided into 42 coarse-grained classes, where e.g. the fine-grained classes
...
"A Hierarchical Grocery Store Image Dataset with Visual and Semantic Labels", which appeared at WACV
2019.
"""
...
class Grocery(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for grocery dataset."""
