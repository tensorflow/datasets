...
_URL = "https://www.kaggle.com/tourist55/alzheimers-dataset-4-class-of-images"
...
class TFFlowers(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self):
    return tfds.core.DatasetInfo(
        builder=self,
        description="A large set of images of Brain Images",
  ...
  def _generate_examples(self, images_dir_path):
    """Generate brain images and labels given the image directory path.
