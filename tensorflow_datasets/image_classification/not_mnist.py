...
notMNIST is a dataset curated by Yaroslav Bulatov by taking publicly available fonts and extracting glyphs from
them to create a dataset similar to MNIST. The 28x28 pixel images comprise of 10 classes with letters A-J.
"""
...
class NotMnist(tfds.core.GeneratorBasedBuilder):
  ...
  def _generate_examples(self, dl_manager, data_path):
    """
