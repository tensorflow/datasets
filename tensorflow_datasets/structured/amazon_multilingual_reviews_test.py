...
"""Tests for amazon_multilingual_reviews dataset module.""" 
...
class AmazonMultilingualReviewsTest(testing.DatasetBuilderTestCase):
  DATASET_CLASS = amazon_multilingual_reviews.AmazonMultilingualReviews
  BUILDER_CONFIG_NAMES_TO_TEST = ["UK"]  
  SPLITS = {
      "train": 5,
  }
