...
def features():
  return collections.OrderedDict([
      ('idnum', (np.int32, convert_to_int)),
      ('state', (np.str_, return_same)),
      ('state2', (np.str_, return_same)),
      ('stfips', (np.int32, convert_to_int)),
      ('zip', (np.int32, convert_to_int)),
      ('region', (np.int32, convert_to_int)),
      ('typebldg', (np.int32, convert_to_int)),
      ('floor', (np.int32, convert_to_int)),
      ('room', (np.int32, convert_to_int)),
      ('basement', (np.str_, return_same)),
      ('windoor', (np.str_, return_same)),
      ('rep', (np.int32, convert_to_int)),
      ('stratum', (np.int32, convert_to_int)),
      ('wave', (np.int32, convert_to_int)),
      ('starttm', (np.int32, convert_to_int)),
      ('stoptm', (np.int32, convert_to_int)),
      ('startdt', (np.int32, convert_to_int)),
      ('stopdt', (np.int32, convert_to_int)),
      ('pcterr', (np.float32, convert_to_float)),
      ('adjwt', (np.float32, convert_to_float)),
      ('dupflag', (np.int32, convert_to_int)),
      ('zipflag', (np.int32, convert_to_int)),
      ('cntyfips', (np.int32, convert_to_int)),
      ('county', (np.str_, return_same)),
      ('Uppm', (np.float32, convert_to_float)),
      ('lon', (np.float32, convert_to_float)),
      ('lat', (np.float32, convert_to_float)),
  ])
