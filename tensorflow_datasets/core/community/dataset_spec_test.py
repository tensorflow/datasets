...
def test_import_export_json_source():
  ...
  assert isinstance(reconstructed_source, github_source.GithubSource)
...
def test_import_export_json_spec():
  ...
  assert isinstance(reconstructed_spec.source, github_source.GithubSource)
