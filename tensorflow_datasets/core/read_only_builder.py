...
class ReadOnlyBuilder(
  ...
  def _info(self) -> dataset_info.DatasetInfo:
    features = None
    if self._info_proto and self._info_proto.HasField('features'):
      features = feature_lib.FeatureConnector.from_proto(
          self._info_proto.features)
    return dataset_info.DatasetInfo(builder=self, features=features)
