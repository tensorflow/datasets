  ...
  **Warning**: calling this function might potentially trigger the download
  ...
  Args:
    ...
    decoders: Nested dict of `Decoder` objects which allow to customize the
        ...
        for more info.
    map_fns: Nested dict of transformation functions to apply after the
      features have been decoded. Function takes as input the decoded feature
      and returns the transformed feature as output. See
      [the guide](https://github.com/tensorflow/datasets/tree/master/docs/transform.md)
      for more info.
  ...
  as_dataset_kwargs["map_fns"] = map_fns
