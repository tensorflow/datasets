...
class _Downloader:
    ...
    @utils.memoize()
    def kaggle_downloader(self, competition_name: str) -> kaggle.KaggleCompetitionDownloader:
        """
    ...
    def _sync_kaggle_download(self, kaggle_url, destination_path):
        ...
        filepath = downloader.download_file(kaggle_file.competition, destination_path)
    ...
    def _sync_file_copy(self, filepath: str, destination_path: str) -> checksums_lib.UrlInfo:
        """
