...
if sys.version_info.major == 2:
  ...
  from itertools import izip as zip  # pylint: disable=g-import-not-at-top,unused-import
else:
...
class TestZipHolder(tf.test.TestCase):
  ...
  def setUpClass(cls):
    ...
    with mock.patch.object(holder.ImageHolder, 'image_size', return_value=(11, 11)):  # pylint:disable=line-too-long
      image = holder.ImageHolder(None, 'image', 'png', None, cls.image_file_path)  # pylint:disable=line-too-long
      image.create_fakes()
    ...
    zip_gen = holder.ZipHolder('test_folder', 'zip', cls.zip_path, cls.out_zip_path)  # pylint: disable=line-too-long
